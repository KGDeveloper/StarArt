...
@implementation KGSquareRoundCell
...
- (void)setUpHeader{
    ...
    self.photoView.layer.cornerRadius = 115;
    self.photoView.layer.masksToBounds = YES;
    self.photoView.sd_layout.topSpaceToView(self.labView, 15).centerXEqualToView(self.contentView).heightIs(230).widthIs(230);
    /** 显示照片书view */
    ...
    self.locationBtu.sd_layout.leftSpaceToView(self.contentView, 15).topSpaceToView(self.photoView, 15).rightEqualToView(self.photoView).heightIs(11);
    /** 收藏标记 */
...
- (void)setLabelWithArr:(NSArray *)arr{
    if (arr.count > 0) {
        ...
        self.labView.sd_layout.leftEqualToView(self.headerImage).topSpaceToView(self.headerImage, 15).rightSpaceToView(self.contentView, 15).heightIs(arr.count*23);;
    }
}
/** 设置内容 */
