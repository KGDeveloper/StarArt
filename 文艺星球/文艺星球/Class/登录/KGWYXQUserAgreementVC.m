...
@interface KGWYXQUserAgreementVC ()

@end

@implementation KGWYXQUserAgreementVC
...
- (void)viewDidLoad {
    ...
    self.title = @"艺文星球科技用户协议";
    
   /** 显示协议 */
    UIScrollView *scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0,0, KGScreenWidth, KGScreenHeight)];
    scrollView.contentSize = CGSizeMake(KGScreenWidth, KGScreenWidth/375*9975);
    scrollView.showsVerticalScrollIndicator = NO;
    scrollView.showsHorizontalScrollIndicator = NO;
    scrollView.bounces = NO;
    [self.view addSubview:scrollView];
    /** 添加协议 */
    UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, KGScreenWidth, KGScreenWidth/375*9975)];
    imageView.image = [UIImage imageNamed:@"yonghuxieyi"];
