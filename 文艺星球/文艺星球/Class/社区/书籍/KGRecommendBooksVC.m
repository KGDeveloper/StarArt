...
@interface KGRecommendBooksVC ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
/** 图书列表 */
...
@implementation KGRecommendBooksVC
...
- (void)requestData{
    ...
    [KGRequest postWithUrl:SelectBookListMore parameters:@{@"navigation":@"今日推荐",@"pageIndex":@(self.pageIndex),@"pageSize":@"20"} succ:^(id  _Nonnull result) {
