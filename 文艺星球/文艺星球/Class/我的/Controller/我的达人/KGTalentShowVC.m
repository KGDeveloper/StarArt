...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    ...
    if (CGRectContainsPoint(CGRectMake(0, KGRectNavAndStatusHight + 20, KGScreenWidth, 50), touchPoint)) {
        [self pushHideenTabbarViewController:[[KGTalentPrivilegeVC alloc]initWithNibName:@"KGTalentPrivilegeVC" bundle:nil] animted:YES];
    }
}
